...
namespace framework\custom\finance;
...
class num2text {
    ...
    private $_chunks_nums = array(1 => 'Ribu', 2 => 'Juta', 3 => 'Miliar', 4 => 'Triliun', 5 => 'Quadliun', 6 => 'Quinliun', 7 => 'Sexliun', 8 => 'Septilliun', 9 => 'Octilliun', 9 => 'Nonilliun', 9 => 'Decilliun', );
    ...
    private function _parse_num($num) {
        $temp = array();
        if (isset($num[2])) {
            if (isset($this->_single_nums[$num[2]]) && $this->_single_nums[$num[2]] != 'Satu') {
                $temp['h'] = $this->_single_nums[$num[2]].' Ratus';
            }
            else if ($this->_single_nums[$num[2]] == 'Satu') {
            	$temp['h'] = 'Seratus';
            }
        }
