...
use \framework\pdf\FPDF;
use \framework\pdf\htmltoolkit;
...
if (!defined('RELATIVE_PATH')) define('RELATIVE_PATH',ROOT_PATH.'framework/pdf/');
if (!defined('FPDF_FONTPATH')) define('FPDF_FONTPATH',ROOT_PATH.'framework/pdf/font/');
require_once(RELATIVE_PATH.'FPDF.class.php');
require_once(RELATIVE_PATH.'htmltoolkit.class.php');
